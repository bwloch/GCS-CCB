...
/* Generated from ../O.Common/Simple.dbd */
...
int Simple_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/bwloch/EPICS/GCS-CCB/IOC/STT_Gas_IOC_Bronkhorst";
...
/* Simple_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"Simple_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    Simple_registerRecordDeviceDriver(*iocshPpdbbase);
}
