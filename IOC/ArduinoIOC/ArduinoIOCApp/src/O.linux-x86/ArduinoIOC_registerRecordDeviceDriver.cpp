...
/* Generated from ../O.Common/ArduinoIOC.dbd */
...
int ArduinoIOC_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/menorzinho/EPICS/ArduinoIOC";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"ArduinoIOC_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    ArduinoIOC_registerRecordDeviceDriver(*iocshPpdbbase);
}
