...
/* Generated from ../O.Common/Bronk_test.dbd */
...
/* Bronk_test_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"Bronk_test_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    Bronk_test_registerRecordDeviceDriver(*iocshPpdbbase);
}
